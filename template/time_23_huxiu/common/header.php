  ...
  <div id="topbar" class="cl"> 
    <div class="wp cl">
      ...
      <div class="hd_logo"> 
		 ...
		 <h2><a href="portal.php"><img src="template/time_23_huxiu/src/logo.png" /></a></h2>
      </div>
      <!-- 导航 -->
      <div class="nav">
        <ul>
      ...
      <div class="th_post y cl" style="display: none;"><a onClick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=$_G[fid]')" href="javascript:;" title="发新帖" style="margin: 0;">发布</a></div>
      <!-- 用户信息 --> 
      <!--{if $_G['uid']}-->
