...
0
|| checktplrefresh('./template/quater_1_douban/common/header.htm', './template/quater_1_douban/common/header_common.htm', 1488249197, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/quater_1_douban', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/quater_1_douban/common/header.htm', './template/quater_1_douban/common/pubsearchform.htm', 1488249197, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/quater_1_douban', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/quater_1_douban/common/header.htm', './template/default/common/header_qmenu.htm', 1488249197, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/quater_1_douban', 'common/header_forum_forumdisplay')
;?>
...
<div id="headnav" <?php if($_GET['diy'] == 'yes' && check_diy_perm($topic)) { ?>class="hides"<?php } ?>>
  <div id="topbar" class="cl"> 
    <div class="wp cl"> 
        ...
        <div class="yp-header-user">
          ...
          <div class="user-link">
            <ul>
              ...
              <?php } ?>
              <li><?php if(!empty($_G['setting']['pluginhooks']['global_myitem_extra'])) echo $_G['setting']['pluginhooks']['global_myitem_extra'];?></li>
              <li><?php if(!empty($_G['setting']['pluginhooks']['global_usernav_extra1'])) echo $_G['setting']['pluginhooks']['global_usernav_extra1'];?></li>
              <li class="l4"><a href="member.php?mod=logging&amp;action=logout&amp;formhash=<?php echo FORMHASH;?>">退出</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="yp-header-user-box">
        <div class="yp-header-user">
          <div class="user-main cl">
            <div class="avatar"> <img src="template/quater_1_douban/src/noLogin.jpg" alt="" height="32" width="32"></div>
            <span class="nickname"><?php echo $_G['member']['username'];?></span><span class="arrow"></span></div>
          <div class="user-link">
            <ul>
        ...
        <div class="yp-header-user">
          ...
          <div class="user-link">
            <ul>
              ...
              <li class="l2"><a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" ><i></i>注册</a></li>
            </ul>
          </div>
        </div>
      </div>
...
<?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_top'])) echo $_G['setting']['pluginhooks']['global_cpnav_top'];?><?php echo adshow("headerbanner/wp a_h");?><?php echo adshow("subnavbanner/a_mu");?><div class="mus_box cl">
