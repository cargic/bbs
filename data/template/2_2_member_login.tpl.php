...
0
|| checktplrefresh('./template/default/member/login.htm', './template/quater_1_douban/common/seccheck.htm', 1488249838, '2', './data/template/2_2_member_login.tpl.php', './template/quater_1_douban', 'member/login')
