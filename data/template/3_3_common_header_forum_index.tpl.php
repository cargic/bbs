...
0
|| checktplrefresh('./template/time_23_huxiu/common/header.htm', './template/time_23_huxiu/common/header_common.htm', 1488267220, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/time_23_huxiu', 'common/header_forum_index')
|| checktplrefresh('./template/time_23_huxiu/common/header.htm', './template/time_23_huxiu/common/pubsearchform.htm', 1488267220, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/time_23_huxiu', 'common/header_forum_index')
|| checktplrefresh('./template/time_23_huxiu/common/header.htm', './template/default/common/header_qmenu.htm', 1488267220, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/time_23_huxiu', 'common/header_forum_index')
;?>
...
<base href="<?php echo $_G['siteurl'];?>" /><link rel="stylesheet" type="text/css" href="data/cache/style_3_common.css?<?php echo VERHASH;?>" /><link rel="stylesheet" type="text/css" href="data/cache/style_3_forum_index.css?<?php echo VERHASH;?>" /><?php if($_G['uid'] && isset($_G['cookie']['extstyle']) && strpos($_G['cookie']['extstyle'], TPLDIR) !== false) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['cookie']['extstyle'];?>/style.css" /><?php } elseif($_G['style']['defaultextstyle']) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['style']['defaultextstyle'];?>/style.css" /><?php } ?>    <script src="template/time_23_huxiu/src/js/jquery.min.js" type="text/javascript"></script>
    <script src="template/time_23_huxiu/src/js/jquery.superslide.js" type="text/javascript"></script>
...
<div id="headnav" <?php if($_GET['diy'] == 'yes' && check_diy_perm($topic)) { ?>class="hides"<?php } ?>>
  ...
  <div id="topbar" class="cl"> 
    <div class="wp cl">
      <!-- 站点LOGO -->
      <div class="hd_logo"> 
         <?php $mnid = getcurrentnav();?> <h2><a href="portal.php"><img src="template/time_23_huxiu/src/logo.png" /></a></h2>
      </div>
      <!-- 导航 -->
      <div class="nav">
        <ul>
  ...
  <?php if(!empty($_G['setting']['pluginhooks']['global_myitem_extra'])) echo $_G['setting']['pluginhooks']['global_myitem_extra'];?>
      ...
      <div class="yp-header-user-box">
        <div class="yp-header-user">
          <div class="user-main ">
            <div class="avatar"> <img src="template/time_23_huxiu/src/noLogin.jpg" alt="" height="32" width="32"></div>
            <span class="nickname"><?php echo $_G['member']['username'];?></span><span class="arrow"></span></div>
          <div class="user-link">
            <ul>
